 ...
 * 
 * @SpringBootTest class RoomBookingManagementSystemApplicationTests extends
 * CustomerTest {
 * 
 * @Override
 * 
 ...
 * 
 * @Test public void getProductsList() throws Exception { String uri = "/all";
 * MvcResult mvcResult =
 ...
 * CustomerEntity[] productlist = super.mapFromJson(content,
 * CustomerEntity[].class); assertTrue(productlist.length > 0); }
 * 
 * @Test public void createProduct() throws Exception { String uri = "/add";
 * CustomerEntity customer = new CustomerEntity(1, "abc", "cde", new Date(5),
 * "jsd@djs", "sjhjsasa"); String inputJson = super.mapToJson(customer);
